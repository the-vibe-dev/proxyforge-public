// ProxyForge Extension SDK — typed API surface for extension authors.
// Re-exports the same types as sdk.d.ts as real TypeScript declarations
// so extensions can import with relative paths (`import from '../../sdk'`).
...
export interface ProxyForgeExtension {
  ...
  onIntruderPayload?(payload: IntruderPayloadProcessorPayload): Promise<IntruderPayloadResult | void>;
