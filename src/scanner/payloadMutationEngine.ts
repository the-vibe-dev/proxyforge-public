...
function variantId(family: PayloadFamily, index: number, suffix: string) {
...
function sqlInjectionVariants(ctx: MutationContext): PayloadVariant[] {
  const f: PayloadFamily = 'sql-injection';
  return [
...
function reflectedXssVariants(ctx: MutationContext): PayloadVariant[] {
  const f: PayloadFamily = 'xss-reflected';
  return [
...
function sstiVariants(ctx: MutationContext): PayloadVariant[] {
  const f: PayloadFamily = 'ssti';
  return [
...
function lfiTraversalVariants(ctx: MutationContext): PayloadVariant[] {
  const f: PayloadFamily = 'lfi-traversal';
  return [
...
function commandInjectionVariants(ctx: MutationContext): PayloadVariant[] {
  const f: PayloadFamily = 'command-injection';
  return [
...
function ssrfVariants(ctx: MutationContext): PayloadVariant[] {
  const f: PayloadFamily = 'ssrf';
...
function openRedirectVariants(ctx: MutationContext): PayloadVariant[] {
  const f: PayloadFamily = 'open-redirect';
  return [
...
function xxeVariants(ctx: MutationContext): PayloadVariant[] {
  const f: PayloadFamily = 'xxe';
  return [
...
function nosqlInjectionVariants(ctx: MutationContext): PayloadVariant[] {
  const f: PayloadFamily = 'nosql-injection';
  return [
...
const FAMILY_DISPATCHERS: Partial<Record<PayloadFamily, (ctx: MutationContext) => PayloadVariant[]>> = {
...
export function generatePayloadVariants(ctx: MutationContext): PayloadVariant[] {
...
export function familiesForInsertionPoint(kind: MutationContext['insertionPointKind']): PayloadFamily[] {
  switch (kind) {
    case 'query':
    case 'body':
    case 'form':
