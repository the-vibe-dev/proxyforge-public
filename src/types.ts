...
export type CallbackExternalOastProviderKind =
  | 'generic-http-relay'
  | 'dns-webhook-relay'
  | 'smtp-relay'
  | 'oast-compatible';
...
export type ExtensionSandboxActionKind =
  | 'tag'
  | 'note'
  | 'request-header'
  | 'response-header'
...
export type ExtensionThirdPartySdkEdgeCategory =
